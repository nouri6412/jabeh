...
<div class="tabs type-editor" id="case27-listing-options-inside" v-cloak>
	...
	<nav class="editor-nav">
		<div class="editor-nav-wrapper">
			<nav-item label="عمومی" tab="settings" :icon="settings.icon ? settings.icon : 'icon-location-pin-add-2'" subtab="general" color="#8070c3"></nav-item>
			<nav-item label="فیلدها" tab="fields" icon="mi menu" color="#0085ba"></nav-item>
			<nav-item label="صفحه تکی" tab="single-page" icon="mi web" subtab="style" color="#e26396"></nav-item>
			<nav-item label="پیشنمایش آگهی" tab="result-template" icon="mi view_day" subtab="preview-card" color="#69c9b4"></nav-item>
			<nav-item label="فرم جستجو" tab="search-page" icon="mi search" subtab="advanced" color="#ee8c57"></nav-item>
		</div>
	</nav>
	...
	<div class="tabs-content">
		<section v-if="currentTab === 'settings'" class="section">
			<div class="sub-tabs">
				<nav-sub-item tab="settings" subtab="general" label="عمومی"></nav-sub-item>
				<nav-sub-item tab="settings" subtab="packages" label="پکیج ها"></nav-sub-item>
				<nav-sub-item tab="settings" subtab="reviews" label="دیدگاه ها"></nav-sub-item>
				<nav-sub-item tab="settings" subtab="seo" label="اسکیما"></nav-sub-item>
				<nav-sub-item tab="settings" subtab="other" label="سایر"></nav-sub-item>
			</div>
		...
		<section v-if="currentTab === 'single-page'" class="section">
			<div class="sub-tabs">
				<nav-sub-item tab="single-page" subtab="style" label="استایل کاور"></nav-sub-item>
				<nav-sub-item tab="single-page" subtab="cover-details" label="جزییات کاور"></nav-sub-item>
				<nav-sub-item tab="single-page" subtab="quick-actions" label="اقدامات سریع"></nav-sub-item>
				<nav-sub-item tab="single-page" subtab="pages" label="محتوا و زبانه ها"></nav-sub-item>
				<nav-sub-item tab="single-page" subtab="similar-listings" label="آگهی ها مشابه"></nav-sub-item>
			</div>
		...
		<section v-if="currentTab === 'result-template'" class="section">
			<div class="sub-tabs">
				<nav-sub-item tab="result-template" subtab="preview-card" label="پیشنمایش آگهی"></nav-sub-item>
				<nav-sub-item tab="result-template" subtab="quick-view" label="نمایش سریع"></nav-sub-item>
			</div>
		...
		<section v-if="currentTab === 'search-page'" class="section">
			<div class="sub-tabs">
				<nav-sub-item tab="search-page" subtab="advanced" label="فرم پیشرفته"></nav-sub-item>
				<nav-sub-item tab="search-page" subtab="basic" label="فرم پایه"></nav-sub-item>
				<nav-sub-item tab="search-page" subtab="order" label="ترتیب آگهی ها"></nav-sub-item>
				<nav-sub-item tab="search-page" subtab="explore-tabs" label="زبانه ها"></nav-sub-item>
			</div>
