...
class Assets {
	...
	public function enqueue_scripts() {
		...
		// moment
		wp_enqueue_script( 'moment-jalali', c27()->template_uri( 'assets/dist/jalali-moment.browser.js' ), null, \MyListing\get_assets_version(), true );
		...
		$case27 = [
			...
			'l10n' => [
				...
				'datepicker'   => [
			        ...
			        'daysOfWeek' => [
			        	_x( 'جمعه', 'Datepicker weekday names', 'my-listing' ),
			        	_x( 'شنبه', 'Datepicker weekday names', 'my-listing' ),
			        	_x( 'یک شنبه', 'Datepicker weekday names', 'my-listing' ),
			        	_x( 'دوشنبه', 'Datepicker weekday names', 'my-listing' ),
			        	_x( 'سه شنبه', 'Datepicker weekday names', 'my-listing' ),
			        	_x( 'چهارشنبه', 'Datepicker weekday names', 'my-listing' ),
			        	_x( 'پنج شنبه', 'Datepicker weekday names', 'my-listing' ),
			        ],
			        'monthNames' => [
