...
class Data_Updater {
	...
	public function add_settings_tab( $tabs ) {
		$tabs['data-updater'] = '<i class="mi update"></i> بروزرسانی داده ها';
		return $tabs;
	}
	...
	private function get_available_updates() {
		return [
			'update_term_counts' => [
				'label' => 'تعداد اصطلاحات را به روز کنید',
				'description' => 'تعداد آگهی های مربوط به هر اصطلاح را دوباره بشمارید.',
				'version' => 2,
				'autorun' => false,
			],
			...
			'cleanup_transients' => [
				'label' => 'گذرا',
				'description' => 'گذراهای قدیمی را که دیگر استفاده نمی شوند حذف می کند.',
				'version' => 1,
				'autorun' => true,
			],
			'remove_unused_options' => [
				'label' => 'گزینه های قدیمی را حذف کنید',
				'description' => 'گزینه های استفاده نشده را از جدول wp_options حذف می کند.',
				'version' => 4,
				'autorun' => true,
			],
