    ...
    !(function (e, i) {
        ...
        function n(e, t, i) {
            if (
                ...
                (this.minYear = O().subtract(100, "year").locale("en").format("YYYY")),
                (this.maxYear = O().add(100, "year").locale("en").format("YYYY")),
                ...
                (this.parentEl = t.parentEl && F(t.parentEl).length ? F(t.parentEl) : F(this.parentEl)),
                (this.container = F(t.template).appendTo(this.parentEl)),
                "object" === yi(t.locale) &&
                    ("string" == typeof t.locale.direction && (this.locale.direction = t.locale.direction),
                    "string" == typeof t.locale.format && (this.locale.format = t.locale.format),
                    "string" == typeof t.locale.separator && (this.locale.separator = t.locale.separator),
                    "object" === yi(t.locale.daysOfWeek) && (this.locale.daysOfWeek = t.locale.daysOfWeek.slice()),
                    "object" === yi(t.locale.monthNames) && (this.locale.monthNames = t.locale.monthNames.slice()),
            ...
            if (
                ...
                "string" == typeof t.startDate && (this.startDate = O(t.startDate, this.locale.format)),
                "string" == typeof t.endDate && (this.endDate = O(t.endDate, this.locale.format)),
                "string" == typeof t.minDate && (this.minDate = O(t.minDate, this.locale.format)),
                "string" == typeof t.maxDate && (this.maxDate = O(t.maxDate, this.locale.format)),
                ...
                "string" == typeof t.applyButtonClasses && (this.applyButtonClasses = t.applyButtonClasses),
                "string" == typeof t.applyClass && (this.applyButtonClasses = t.applyClass),
                "string" == typeof t.cancelButtonClasses && (this.cancelButtonClasses = t.cancelButtonClasses),
                "string" == typeof t.cancelClass && (this.cancelButtonClasses = t.cancelClass),
                ...
                "boolean" == typeof t.showISOWeekNumbers && (this.showISOWeekNumbers = t.showISOWeekNumbers),
                "string" == typeof t.buttonClasses && (this.buttonClasses = t.buttonClasses),
                "object" === yi(t.buttonClasses) && (this.buttonClasses = t.buttonClasses.join(" ")),
                ...
                "boolean" == typeof t.showCustomRangeLabel && (this.showCustomRangeLabel = t.showCustomRangeLabel),
                ...
                "boolean" == typeof t.timePicker24Hour && (this.timePicker24Hour = t.timePicker24Hour),
                "boolean" == typeof t.autoApply && (this.autoApply = t.autoApply),
                "boolean" == typeof t.autoUpdateInput && (this.autoUpdateInput = t.autoUpdateInput),
                "boolean" == typeof t.linkedCalendars && (this.linkedCalendars = t.linkedCalendars),
                "function" == typeof t.isInvalidDate && (this.isInvalidDate = t.isInvalidDate),
                "function" == typeof t.isCustomDate && (this.isCustomDate = t.isCustomDate),
                "boolean" == typeof t.alwaysShowCalendars && (this.alwaysShowCalendars = t.alwaysShowCalendars),
            ...
            if (void 0 === t.startDate && void 0 === t.endDate && F(this.element).is(":text")) {
                ...
                (s = o = null),
                    2 == c.length ? ((s = O(c[0], this.locale.format)), (o = O(c[1], this.locale.format))) : this.singleDatePicker && "" !== l && ((s = O(l, this.locale.format)), (o = O(l, this.locale.format))),
                    null !== s && null !== o && (this.setStartDate(s), this.setEndDate(o));
            }
            if ("object" === yi(t.ranges)) {
                for (r in t.ranges) {
                    (s = "string" == typeof t.ranges[r][0] ? O(t.ranges[r][0], this.locale.format) : O(t.ranges[r][0])),
                        (o = "string" == typeof t.ranges[r][1] ? O(t.ranges[r][1], this.locale.format) : O(t.ranges[r][1])),
                        this.minDate && s.isBefore(this.minDate) && (s = this.minDate.clone());
                    var d = this.maxDate;
                    if (
                        (this.maxSpan && d && s.clone().add(this.maxSpan).isAfter(d) && (d = s.clone().add(this.maxSpan)),
                        d && o.isAfter(d) && (o = d.clone()),
                        !((this.minDate && o.isBefore(this.minDate, this.timepicker ? "minute" : "day")) || (d && s.isAfter(d, this.timepicker ? "minute" : "day"))))
                    ) {
                        var u;
            ...
            "function" == typeof i && (this.callback = i),
                ...
                ((void 0 === t.ranges && !this.singleDatePicker) || this.alwaysShowCalendars) && this.container.addClass("show-calendar"),
                ...
                this.container
                    ...
                    .on("mousedown.daterangepicker", "td.available", F.proxy(this.clickDate, this))
                    .on("mouseenter.daterangepicker", "td.available", F.proxy(this.hoverDate, this))
                    .on("change.daterangepicker", "select.yearselect", F.proxy(this.monthOrYearChanged, this))
                    .on("change.daterangepicker", "select.monthselect", F.proxy(this.monthOrYearChanged, this))
                    .on("change.daterangepicker", "select.hourselect,select.minuteselect,select.secondselect,select.ampmselect", F.proxy(this.timeChanged, this)),
                this.container.find(".ranges").on("click.daterangepicker", "li", F.proxy(this.clickRange, this)),
                ...
                this.element.is("input") || this.element.is("button")
                    ...
                    : (this.element.on("click.daterangepicker", F.proxy(this.toggle, this)), this.element.on("keydown.daterangepicker", F.proxy(this.toggle, this))),
                this.updateElement();
        }
        return (
            (n.prototype = {
                    ...
                    if (this.timePicker) {
                        ...
                        if (this.endDate) {
                            if (
                                ...
                                "PM" === (n = this.container.find(".left .ampmselect").val()) && e < 12 && (e += 12), "AM" === n && 12 === e && (e = 0);
                        } else if (
                            ...
                            "PM" === (n = this.container.find(".right .ampmselect").val()) && e < 12 && (e += 12), "AM" === n && 12 === e && (e = 0);
                ...
                renderCalendar: function (e) {
                    var t,
                        i = (t = "left" == e ? this.leftCalendar : this.rightCalendar).month.month(),
                        n = t.month.year(),
                        a = t.month.hour(),
                        s = t.month.minute(),
                        o = t.month.second(),
                    ...
                    for (var g = O([u, d, m, 12, s, o]), y = ((f = 0), 0), v = 0; f < 42; f++, y++, g = O(g).add(24, "hour"))
                        0 < f && y % 7 == 0 && ((y = 0), v++),
                            (t[v][y] = g.clone().hour(a).minute(s).second(o)),
                            g.hour(12),
                            this.minDate && t[v][y].format("YYYY-MM-DD") == this.minDate.format("YYYY-MM-DD") && t[v][y].isBefore(this.minDate) && "left" == e && (t[v][y] = this.minDate.clone()),
                            this.maxDate && t[v][y].format("YYYY-MM-DD") == this.maxDate.format("YYYY-MM-DD") && t[v][y].isAfter(this.maxDate) && "right" == e && (t[v][y] = this.maxDate.clone());
                    ...
                    (D += "<thead>"),
                        ...
                        (w && !w.isBefore(t.firstDay)) || (this.linkedCalendars && "left" != e) ? (D += "<th></th>") : (D += '<th class="prev available"><span></span></th>');
                    var k = this.locale.monthNames[t[1][1].month()] + t[1][1].format(" YYYY");
                    if (this.showDropdowns) {
                        for (var x = t[1][1].month(), C = t[1][1].year(), S = (b && b.year()) || this.maxYear, M = (w && w.year()) || this.minYear, T = C == M, I = C == S, _ = '<select class="monthselect">', L = 0; L < 12; L++)
                            (!T || L >= w.month()) && (!I || L <= b.month())
                                ? (_ += "<option value='" + L + "'" + (L === x ? " selected='selected'" : "") + ">" + this.locale.monthNames[L] + "</option>")
                                : (_ += "<option value='" + L + "'" + (L === x ? " selected='selected'" : "") + " disabled='disabled'>" + this.locale.monthNames[L] + "</option>");
                        _ += "</select>";
                    ...
                    if (
                        ...
                        (b && !b.isAfter(t.lastDay)) || (this.linkedCalendars && "right" != e && !this.singleDatePicker) ? (D += "<th></th>") : (D += '<th class="next available"><span></span></th>'),
                        (D += "</tr>"),
                        (D += "<tr>"),
                    ...
                    for (v = 0; v < 6; v++) {
                        ...
                        for (y = 0; y < 7; y++) {
                            var Y = [];
                            t[v][y].isSame(new Date(), "day") && Y.push("today"),
                                5 < t[v][y].isoWeekday() && Y.push("weekend"),
                                t[v][y].month() != t[1][1].month() && Y.push("off"),
                                this.minDate && t[v][y].isBefore(this.minDate, "day") && Y.push("off", "disabled"),
                                b && t[v][y].isAfter(b, "day") && Y.push("off", "disabled"),
                                this.isInvalidDate(t[v][y]) && Y.push("off", "disabled"),
                                t[v][y].format("YYYY-MM-DD") == this.startDate.format("YYYY-MM-DD") && Y.push("active", "start-date"),
                                null != this.endDate && t[v][y].format("YYYY-MM-DD") == this.endDate.format("YYYY-MM-DD") && Y.push("active", "end-date"),
                                null != this.endDate && t[v][y] > this.startDate && t[v][y] < this.endDate && Y.push("in-range");
                ...
                renderTimePicker: function (e) {
                    if ("right" != e || this.endDate) {
                        var t,
                            ...
                            n,
                            a = this.maxDate;
                        if ((!this.maxSpan || (this.maxDate && !this.startDate.clone().add(this.maxSpan).isAfter(this.maxDate)) || (a = this.startDate.clone().add(this.maxSpan)), "left" == e))
                            ...
                            if (
                                "" != s.html() &&
                                (i.hour(i.hour() || s.find(".hourselect option:selected").val()),
                                i.minute(i.minute() || s.find(".minuteselect option:selected").val()),
                                i.second(i.second() || s.find(".secondselect option:selected").val()),
                                !this.timePicker24Hour)
                            ) {
                        ...
                        for (var r = this.timePicker24Hour ? 0 : 1, l = this.timePicker24Hour ? 23 : 12, c = r; c <= l; c++) {
                            ...
                            n && u.minute(59).isBefore(n) && (h = !0),
                                ...
                                d != i.hour() || h
                                    ? (t += h ? '<option value="' + c + '" disabled="disabled" class="disabled">' + c + "</option>" : '<option value="' + c + '">' + c + "</option>")
                                    : (t += '<option value="' + c + '" selected="selected">' + c + "</option>");
                        }
                        ...
                        for (c = 0; c < 60; c += this.timePickerIncrement) {
                            ...
                            n && u.second(59).isBefore(n) && (h = !0),
                                ...
                                i.minute() != c || h
                                    ? (t += h ? '<option value="' + c + '" disabled="disabled" class="disabled">' + p + "</option>" : '<option value="' + c + '">' + p + "</option>")
                                    : (t += '<option value="' + c + '" selected="selected">' + p + "</option>");
                        }
                        ...
                        if (!this.timePicker24Hour) {
                            ...
                            var f = "",
                                m = "";
                            n && i.clone().hour(12).minute(0).second(0).isBefore(n) && (f = ' disabled="disabled" class="disabled"'),
                                a && i.clone().hour(0).minute(0).second(0).isAfter(a) && (m = ' disabled="disabled" class="disabled"'),
                                12 <= i.hour()
                                    ? (t += '<option value="AM"' + f + '>AM</option><option value="PM" selected="selected"' + m + ">PM</option>")
                                    : (t += '<option value="AM" selected="selected"' + f + '>AM</option><option value="PM"' + m + ">PM</option>"),
                                (t += "</select>");
                        }
                ...
                move: function () {
                    ...
                    this.parentEl.is("body") ||
                        ((t = { top: this.parentEl.offset().top - this.parentEl.scrollTop(), left: this.parentEl.offset().left - this.parentEl.scrollLeft() }), (i = this.parentEl[0].clientWidth + this.parentEl.offset().left)),
                        (e = "up" == this.drops ? this.element.offset().top - this.container.outerHeight() - t.top : this.element.offset().top + this.element.outerHeight() - t.top),
                        this.container["up" == this.drops ? "addClass" : "removeClass"]("drop-up"),
                        "left" == this.opens
                            ? (this.container.css({ top: e, right: i - this.element.offset().left - this.element.outerWidth(), left: "auto" }), this.container.offset().left < 0 && this.container.css({ right: "auto", left: 9 }))
                            : "center" == this.opens
                            ? (this.container.css({ top: e, left: this.element.offset().left - t.left + this.element.outerWidth() / 2 - this.container.outerWidth() / 2, right: "auto" }),
                              this.container.offset().left < 0 && this.container.css({ right: "auto", left: 9 }))
                            : (this.container.css({ top: e, left: this.element.offset().left - t.left, right: "auto" }),
                              this.container.offset().left + this.container.outerWidth() > F(window).width() && this.container.css({ left: "auto", right: 0 }));
                },
                show: function (e) {
                    this.isShowing ||
                ...
                clickNext: function (e) {
                    F(e.target).parents(".drp-calendar").hasClass("left") ? this.leftCalendar.month.add(1, "month") : (this.rightCalendar.month.add(1, "month"), this.linkedCalendars && this.leftCalendar.month.add(1, "month")),
                        this.updateCalendars();
                },
                hoverDate: function (e) {
                    if (F(e.target).hasClass("available")) {
                        var t = F(e.target).attr("data-title"),
                            ...
                            c = this.startDate;
                        this.endDate ||
                            this.container.find(".drp-calendar tbody td").each(function (e, t) {
                ...
                monthOrYearChanged: function (e) {
                    ...
                    t || ((s < this.startDate.year() || (s == this.startDate.year() && a < this.startDate.month())) && ((a = this.startDate.month()), (s = this.startDate.year()))),
                        this.minDate && (s < this.minDate.year() || (s == this.minDate.year() && a < this.minDate.month())) && ((a = this.minDate.month()), (s = this.minDate.year())),
                        this.maxDate && (s > this.maxDate.year() || (s == this.maxDate.year() && a > this.maxDate.month())) && ((a = this.maxDate.month()), (s = this.maxDate.year())),
                        t
                            ? (this.leftCalendar.month.month(a).year(s), this.linkedCalendars && (this.rightCalendar.month = this.leftCalendar.month.clone().add(1, "month")))
                            : (this.rightCalendar.month.month(a).year(s), this.linkedCalendars && (this.leftCalendar.month = this.rightCalendar.month.clone().subtract(1, "month"))),
                        this.updateCalendars();
                },
                ...
                elementChanged: function () {
                    if (this.element.is("input") && this.element.val().length) {
                        var e = this.element.val().split(this.locale.separator),
                            t = null,
                            i = null;
                        2 === e.length && ((t = O(e[0], this.locale.format)), (i = O(e[1], this.locale.format))),
                            (!this.singleDatePicker && null !== t && null !== i) || (i = t = O(this.element.val(), this.locale.format)),
                            t.isValid() && i.isValid() && (this.setStartDate(t), this.setEndDate(i), this.updateView());
                    }
                },
                keydown: function (e) {
        ...
        (t = function () {
            return function (p, n, e, t) {
                ...
                function o() {
                    at && (f.unbind(document, "mousemove", o), f.addClass(p, "pswp--has_mouse"), (g.mouseUsed = !0), y("mouseUsed")),
                ...
                function j(e) {
                    ...
                    return (
                        le
                            ...
                            ? e.touches && 0 < e.touches.length && ((Tt[0] = P(e.touches[0], St)), 1 < e.touches.length && (Tt[1] = P(e.touches[1], Mt)))
                            : ((St.x = e.pageX), (St.y = e.pageY), (St.id = ""), (Tt[0] = St)),
                        Tt
                    );
                }
                function $(e, t) {
                    var i,
                        ...
                        c = bt.x - ft.x;
                    if (
                        ((i = o > Ae.min[e] || o < Ae.max[e] ? g.panEndFriction : 1),
                        (o = Ue[e] + t[e] * i),
                        (g.allowPanToNext || z === m.currItem.initialZoomLevel) &&
                            (Ye
                                ? "h" !== $e ||
                                  "x" !== e ||
                                  Me ||
                                  (r
                                      ? (o > Ae.min[e] && ((i = g.panEndFriction), Ae.min[e] - o, (n = Ae.min[e] - Ne[e])), (n <= 0 || c < 0) && 1 < Nt() ? ((s = l), c < 0 && l > ft.x && (s = ft.x)) : Ae.min.x !== Ae.max.x && (a = o))
                                      : (o < Ae.max[e] && ((i = g.panEndFriction), o - Ae.max[e], (n = Ne[e] - Ae.max[e])), (n <= 0 || 0 < c) && 1 < Nt() ? ((s = l), 0 < c && l < ft.x && (s = ft.x)) : Ae.min.x !== Ae.max.x && (a = o)))
                                : (s = l),
                            "x" === e))
                    )
                        return void 0 !== s && (u(s, !0), (_e = s !== ft.x)), Ae.min.x !== Ae.max.x && (void 0 !== a ? (Ue.x = a) : _e || (Ue.x += t.x * i)), void 0 !== s;
                        ...
                        if (Bt) e.preventDefault();
                            ...
                            (Le = null),
                                ...
                                !Ee &&
                                    ...
                                    !je &&
                                    !_e &&
                                    ((Z = z), (Ee = Se = !(Me = !1)), (He.y = He.x = 0), w(Ne, Ue), w(lt, i[0]), w(ct, i[1]), A(lt, ct, kt), (Dt.x = Math.abs(kt.x) - Ue.x), (Dt.y = Math.abs(kt.y) - Ue.y), (Pe = L(lt, ct)));
                        }
                }
                function O(e) {
                ...
                function F(e) {
                    ...
                    var o = -1;
                    if (
                        (0 === s && ((Ce = !1), f.unbind(window, Q, m), xt(), Ee ? (o = 0) : -1 !== wt && (o = d() - wt)),
                        (wt = 1 === s ? d() : -1),
                        (n = -1 !== o && o < 150 ? "zoom" : "swipe"),
                        Ee && s < 2 && ((Ee = !1), 1 === s && (n = "zoomPointerUp"), y("zoomGestureEnded")),
                        (Le = null),
                        Te || Me || je || ke)
                    )
                ...
                var R,
                    ...
                    rt = {
                        ...
                        init: function () {
                            if (!R && !B) {
                                ...
                                y("firstUpdate"),
                                    ...
                                    g.modal && (Ze ? (p.style.position = "fixed") : ((p.style.position = "absolute"), (p.style.top = f.getScrollY() + "px"))),
                                    void 0 === me && (y("initialLayout"), (me = pe = f.getScrollY()));
                                var i = "pswp--open ";
                                for (
                                ...
                                fe || f.bind(m.scrollWrap, W, m),
                                    s("initialZoomInEnd", function () {
                                        m.setContent(te[0], N - 1),
                                            ...
                                            ge.transform && f.bind(m.scrollWrap, "click", m),
                                            g.mouseUsed || f.bind(document, "mousemove", o),
                        ...
                        close: function () {
                            R &&
                                ...
                                f.unbind(document, "mousemove", o),
                                ge.transform && f.unbind(m.scrollWrap, "click", m),
                                Ce && f.unbind(window, Q, m),
                                clearTimeout(ye),
                                y("unbindEvents"),
                        ...
                        updateCurrItem: function (e) {
                            if (0 !== ze) {
                                ...
                                if (!(e && i < 2)) {
                                    ...
                                    for (var n = 0; n < i; n++)
                                        0 < ze
                                            ? ((t = te.shift()), (te[2] = t), nt((++V + 2) * qe.x, t.el.style), m.setContent(t, N - i + n + 1 + 1))
                                            : ((t = te.pop()), te.unshift(t), nt(--V * qe.x, t.el.style), m.setContent(t, N + i - n - 1 - 1));
                                    if (Ye && 1 === Math.abs(ze)) {
                                        var a = Ht(ie);
                            ...
                            if (((Ve.x = m.scrollWrap.clientWidth), (Ve.y = m.scrollWrap.clientHeight), S(), (qe.x = Ve.x + Math.round(Ve.x * g.spacing)), (qe.y = Ve.y), u(qe.x * Qe), y("beforeResize"), void 0 !== V)) {
                                for (var i, n, a, s = 0; s < 3; s++)
                                    (i = te[s]),
                                        ...
                                        (a = N + s - 1),
                                        g.loop && 2 < Nt() && (a = l(a)),
                                        (n = Ht(a)) && (ee || n.needsUpdate || !n.bounds)
                                            ? (m.cleanSlide(n), m.setContent(i, a), 1 === s && ((m.currItem = n), m.updateCurrZoomItem(!0)), (n.needsUpdate = !1))
                                            : -1 === i.index && 0 <= a && m.setContent(i, a),
                                        n && n.container && (qt(n, Ve), zt(n), it(n));
                                ee = !1;
                            }
                        ...
                        var t,
                            ...
                            n = {
                                ...
                                calculateSwipeSpeed: function (e) {
                                    (i = 1 < mt.length ? ((t = d() - we + 50), mt[mt.length - 2][e]) : ((t = d() - ve), ht[e])),
                                ...
                                calculateOverBoundsAnimOffset: function (t, e) {
                                    n.backAnimStarted[t] ||
                                        (Ue[t] > Ae.min[t] ? (n.backAnimDestination[t] = Ae.min[t]) : Ue[t] < Ae.max[t] && (n.backAnimDestination[t] = Ae.max[t]),
                                        void 0 !== n.backAnimDestination[t] &&
                                            ...
                                            n.speedDecelerationRatioAbs[t] < 0.05 &&
                                                ...
                                                _("bounceZoomPan" + t, Ue[t], n.backAnimDestination[t], e || 300, f.easing.sine.out, function (e) {
                                                    (Ue[t] = e), tt();
                                                }))));
                                },
                                ...
                                panAnimLoop: function () {
                                    if (
                                        ...
                                        return (Ue.x = Math.round(Ue.x)), (Ue.y = Math.round(Ue.y)), tt(), void M("zoomPan");
                                },
                            };
                        return n;
                    },
                    Lt = function (e) {
                        if ((e.calculateSwipeSpeed("y"), (Ae = m.currItem.bounds), (e.backAnimDestination = {}), (e.backAnimStarted = {}), Math.abs(e.lastFlickSpeed.x) <= 0.05 && Math.abs(e.lastFlickSpeed.y) <= 0.05))
                    ...
                    Et = function (e, t) {
                        ...
                        var r,
                            ...
                            c = Math.abs(l - bt.x);
                        return (
                            (r = i || l > bt.x == 0 < t.lastFlickSpeed.x ? ((r = 0 < Math.abs(t.lastFlickSpeed.x) ? c / Math.abs(t.lastFlickSpeed.x) : 333), (r = Math.min(r, 400)), Math.max(r, 250)) : 333),
                            yt === N && (i = !1),
                            (je = !0),
                            y("mainScrollAnimStart"),
                            _("mainScroll", bt.x, l, r, f.easing.cubic.out, u, function () {
                    ...
                    publicMethods: {
                        initGestures: function () {
                            ...
                            (le = ge.pointerEvent) && ge.touch && (ge.touch = !1),
                                ...
                                (q[se] = F),
                                oe && (q[oe] = q[se]),
                                ge.touch && ((W += " mousedown"), (Q += " mousemove mouseup"), (q.mousedown = q[ne]), (q.mousemove = q[ae]), (q.mouseup = q[se])),
                ...
                var Ot,
                    ...
                    Ut = function (o, e, r, t) {
                        ...
                        function c() {
                            M("initialZoom"),
                                r ? (m.template.removeAttribute("style"), m.bg.removeAttribute("style")) : (v(1), e && (e.style.display = "block"), f.addClass(p, "pswp--animated-in"), y("initialZoom" + (r ? "OutEnd" : "InEnd"))),
                                t && t(),
                                (Bt = !1);
                        }
                        ...
                        var u, h;
                        (u = H),
                            (h = !m.currItem.src || m.currItem.loadError || g.showHideOpacity),
                            o.miniImg && (o.miniImg.style.webkitBackfaceVisibility = "hidden"),
                            r || ((z = l.w / o.w), (Ue.x = l.x), (Ue.y = l.y - pe), (m[h ? "template" : "bg"].style.opacity = 0.001), tt()),
                            T("initialZoom"),
                    ...
                    qt = function (e, t, i) {
                        ...
                        var n = !i;
                        if ((n && (e.vGap || (e.vGap = { top: 0, bottom: 0 }), y("parseVerticalMargin", e)), (Vt.x = t.x), (Vt.y = t.y - e.vGap.top - e.vGap.bottom), n)) {
                            var a = Vt.x / e.w,
                                s = Vt.y / e.h;
                            e.fitRatio = a < s ? a : s;
                            var o = g.scaleMode;
                            "orig" === o ? (i = 1) : "fit" === o && (i = e.fitRatio), 1 < i && (i = 1), (e.initialZoomLevel = i), e.bounds || (e.bounds = { center: { x: 0, y: 0 }, max: { x: 0, y: 0 }, min: { x: 0, y: 0 } });
                        }
                        return i
                            ? ((function (e, t, i) {
                                  var n = e.bounds;
                                  (n.center.x = Math.round((Vt.x - t) / 2)),
                                      (n.center.y = Math.round((Vt.y - i) / 2) + e.vGap.top),
                                      (n.max.x = t > Vt.x ? Math.round(Vt.x - t) : n.center.x),
                                      (n.max.y = i > Vt.y ? Math.round(Vt.y - i) + e.vGap.top : n.center.y),
                                      (n.min.x = t > Vt.x ? 0 : n.center.x),
                                      (n.min.y = i > Vt.y ? e.vGap.top : n.center.y);
                              })(e, e.w * i, e.h * i),
                    ...
                    publicMethods: {
                        ...
                        setContent: function (t, i) {
                            ...
                            if (a) {
                                ...
                                if ((!a.src && a.html && (a.html.tagName ? s.appendChild(a.html) : (s.innerHTML = a.html)), $t(a), qt(a, Ve), !a.src || a.loadError || a.loaded))
                                    a.src && !a.loadError && (((n = f.createEl("pswp__img", "img")).style.opacity = 1), (n.src = a.src), zt(a, n), Yt(0, a, s, n));
                                else {
                                    if (
                                        ((a.loadComplete = function (e) {
                                            if (R) {
                                                if (t && t.index === i) {
                                                    ...
                                                    e.imageAppended
                                                        ? !Bt && e.placeholder && ((e.placeholder.style.display = "none"), (e.placeholder = null))
                                                        : ge.transform && (je || Bt)
                                    ...
                                    a.loading || jt(a), m.allowProgressiveImg() && (!Rt && ge.transform ? Qt.push({ item: a, baseDiv: s, img: a.img, index: i, holder: t }) : Yt(0, a, s, a.img, 0, !0));
                                }
                    ...
                    i("DesktopZoom", {
                        publicMethods: {
                            ...
                            handleMouseWheel: function (e) {
                                ...
                                else if ("wheelDelta" in e) e.wheelDeltaX && (Xt.x = -0.16 * e.wheelDeltaX), e.wheelDeltaY ? (Xt.y = -0.16 * e.wheelDeltaY) : (Xt.y = -0.16 * e.wheelDelta);
                                else {
                            ...
                            toggleDesktopZoom: function (e) {
                                e = e || { x: Ve.x / 2 + We.x, y: Ve.y / 2 + We.y };
                ...
                function ni() {
                    if ((oi && clearTimeout(oi), ot || Ce)) oi = setTimeout(ni, 500);
                        ...
                        mi ? "#" + i !== window.location.hash && history[ui ? "replaceState" : "pushState"]("", document.title, n) : ui ? fi.replace(n) : (fi.hash = i),
                            (ui = !0),
                        ...
                        initHistory: function () {
                            if ((f.extend(g, gi, !0), g.history)) {
                                (fi = window.location),
                                    (ui = hi = pi = !1),
                                    (di = ei()),
                                    (mi = "pushState" in history),
                                    -1 < di.indexOf("gid=") && (di = (di = di.split("&gid=")[0]).split("?gid=")[0]),
                                ...
                                -1 < t && "&" === (di = di.substring(0, t)).slice(-1) && (di = di.slice(0, -1)),
                                    setTimeout(function () {
        ...
        "function" == typeof define && define.amd ? define(t) : "object" === ("undefined" == typeof exports ? "undefined" : yi(exports)) ? (module.exports = t()) : (e.PhotoSwipe = t()),
        (i = window),
        (n = function () {
            return function (a, r) {
                function e(e) {
                    ...
                    return (
                        ...
                        !!t.href &&
                            (!!t.hasAttribute("download") ||
                                (window.open(t.href, "pswp_share", "scrollbars=yes,resizable=yes,toolbar=no,location=yes,width=550,height=420,top=100,left=" + (window.screen ? Math.round(screen.width / 2 - 275) : 100)), P || s(), !1))
                    );
                }
                function l(e) {
                    for (var t = 0; t < S.closeElClasses.length; t++) if (r.hasClass(e, "pswp__" + S.closeElClasses[t])) return !0;
                }
                function c(e) {
                ...
                var u,
                    ...
                    Y = function () {
                        for (var e, t, i, n, a = "", s = 0; s < S.shareButtons.length; s++)
                            (e = S.shareButtons[s]),
                                ...
                                (a +=
                                    ...
                                    e.label +
                                    "</a>"),
                                S.parseShareButtonOut && (a = S.parseShareButtonOut(e, a));
                ...
                (_.init = function () {
                    r.extend(a.options, A, !0),
                        ...
                        (function () {
                            ...
                            b("onVerticalDrag", function (e) {
                                E && e < 0.95 ? _.hideControls() : !E && 0.95 <= e && _.showControls();
                            }),
                                b("onPinchClose", function (e) {
                                    E && e < 0.9 ? (_.hideControls(), (t = !0)) : t && !E && 0.9 < e && _.showControls();
                                }),
                        ...
                        b("unbindEvents", function () {
                            P || s(),
                                ...
                                r.unbind(a.scrollWrap, "pswpTap", _.onGlobalTap),
                                r.unbind(a.scrollWrap, "mouseover", _.onMouseOver),
                                u && (r.unbind(document, u.eventK, _.updateFullscreen), u.isFullscreen() && ((S.hideAnimationDuration = 0), u.exit()), (u = null));
                        }),
                        b("destroy", function () {
                                ...
                                if (e)
                                    for (var t = e.length, i = 0; i < t; i++) {
                                        ...
                                        for (var n = 0; n < O.length; n++)
                                            (o = O[n]), -1 < s.indexOf("pswp__" + o.name) && (S[o.option] ? (r.removeClass(a, "pswp__element--disabled"), o.onInit && o.onInit(a)) : r.addClass(a, "pswp__element--disabled"));
                                    }
                            }
                            var a, s, o;
                            e(h.children);
                        ...
                        S.fullscreenEl &&
                            ...
                            ((u = u || _.getFullscreenAPI()) ? (r.bind(document, u.eventK, _.updateFullscreen), _.updateFullscreen(), r.addClass(a.template, "pswp--supports-fs")) : r.removeClass(a.template, "pswp--supports-fs")),
                        S.preloaderEl &&
                            (K(!0),
                    ...
                    (_.updateFullscreen = function (e) {
                        e &&
                            ...
                            r[(u.isFullscreen() ? "add" : "remove") + "Class"](a.template, "pswp--fs");
                    }),
        ...
        "function" == typeof define && define.amd ? define(n) : "object" === ("undefined" == typeof exports ? "undefined" : yi(exports)) ? (module.exports = n()) : (i.PhotoSwipeUI_Default = n()),
        ...
        jQuery(function (t) {
            t("body").on("click", ".open-photo-swipe", function (e) {
                e.preventDefault(), new MyListing.PhotoSwipe([{ src: this.href, w: this.dataset.fullWidth || 0, h: this.dataset.fullHeight || 0, el: this }], 0);
            }),
                t(".photoswipe-gallery .photoswipe-item").on("click", function (e) {
                    ...
                    t(this)
                        ...
                        .each(function (e, t) {
                            i.push({ src: t.href || t.dataset.large_image, w: t.dataset.fullWidth || t.dataset.large_image_width || 0, h: t.dataset.fullHeight || t.dataset.large_image_height || 0, el: t }), t == n && (a = e);
                        }),
        ...
        jQuery(function (n) {
            ...
            var a = function (t) {
                ...
                var e = n.param({ action: "mylisting_quick_search", security: CASE27.ajax_nonce, s: t.input.val().trim() });
                n.ajax({
                    url: CASE27.ajax_url,
                    type: "GET",
                    dataType: "json",
        ...
        (function (m) {
            ...
            m.extend(e.defaults, { dropdownPosition: "auto" });
            ...
            t.prototype._positionDropdown = function () {
                ...
                "above" === f || "below" === f ? (n = f) : (t || i || (n = "below"), d || !c || t ? !c && d && t && (n = "below") : (n = "above")),
                    ("above" == n || (t && "below" !== n)) && (u.top = s.top - p.top - o),
                    null != n &&
        ...
        (MyListing.CustomSelect = function (e, t) {
            ...
            if (((this.el = jQuery(e)), this.el.length)) {
                ...
                if (
                    ...
                    var a = "object" === yi(this.el.data("mylisting-ajax-params")) ? this.el.data("mylisting-ajax-params") : {},
                        s = {
        ...
        (MyListing.TermHierarchy = function (e) {
            (this.input = jQuery(e)),
                ...
                this.input.length &&
                    ...
                    (this.term_value = "slug" === this.ajax_params["term-value"] ? "slug" : "id"),
                    ...
                    (this.template = "alternate" === this.input.data("template") ? "alternate" : "default"),
                    this.el.addClass("tpl-" + this.template),
                    this.selected.length ? this.handleDefaultValue() : this.addChildSelect({ index: 0, select: null }),
                    this.label.on(
                        "click",
                        function () {
        ...
        (MyListing.TermHierarchy.prototype.maybeAddChildSelect = function (t) {
            ...
            if ((this.el.find(e).find("select").select2("destroy"), this.el.find(e).remove(), t.select.val())) {
                var n = jQuery.extend({}, t.select.data("mylisting-ajax-params"), { page: 1, security: CASE27.ajax_nonce, search: "" });
                (n["slug" === this.term_value ? "parent" : "parent_id"] = t.select.val()),
        ...
        (MyListing.TermHierarchy.prototype.addChildSelect = function (i) {
            ...
            if (("alternate" === this.template && e.find("select").data("dropdown-position", "below"), 0 === i.index))
            ...
            return (
                (s["slug" === this.term_value ? "parent" : "parent_id"] = 0 === i.index ? 0 : i.select.val()),
                e.find("select").data("mylisting-ajax-params", s).attr("placeholder", t),
                this.el.append(e),
                ...
                e.find("select").on(
                    ...
                    function (e) {
                        ...
                        this.input.val(e.detail.value || t).trigger("change"), this.updateLabel(n), this.maybeAddChildSelect({ index: i.index + 1, select: jQuery(e.target) });
                    }.bind(this)
                ),
                e
            );
        ...
        (MyListing.Handlers.Bookmark_Button = function (e, t) {
            ...
            if (!t.hasClass("bookmarking")) {
                ...
                t.addClass("bookmarking").toggleClass("bookmarked"),
                    t.find(".action-label").html(t.hasClass("bookmarked") ? t.data("active-label") : t.data("label")),
        ...
        jQuery(document).ready(
            (window.case27_ready_script = function (a) {
                a(document).trigger("mylisting:refresh-scripts"),
                    a([".c27-main-header", ".finder-container", ".add-listing-step", ".hide-until-load"].join(", ")).css("opacity", 1),
                    setTimeout(function () {
                ...
                if (
                    (jQuery("#whats-new-textarea textarea").attr("placeholder", e),
                    a(".woocommerce-MyAccount-navigation ul").length && a(".woocommerce-MyAccount-navigation ul li.is-active, .woocommerce-MyAccount-navigation ul li.current-menu-item").length)
                ) {
                ...
                if (
                    ...
                    a("body").on("hover", ".listing-feed-2", function (e) {
                        a(this).find('[data-toggle="tooltip"]').tooltip({ trigger: "hover" });
                    }),
                    a(".card-view a").on("click", function (e) {
                        e.preventDefault(), a("body").css({ overflow: "auto", height: "auto" }), a(".finder-listings").removeClass("fl-hidden"), a(".finder-map").removeClass("fm-visible");
                    }),
                    a(".fc-type-2 .finder-overlay").on("click", function () {
                        a(".fc-type-2").removeClass("fc-type-2-open");
                    }),
                    a(".testimonial-carousel.owl-carousel").owlCarousel({ mouseDrag: !1, items: 1, center: !0, autoplay: !0, dotsContainer: "#customDots" }),
                    ...
                    a(".gallery-carousel").each(function (e, t) {
                        ...
                        a(t).owlCarousel({ margin: 10, items: i, mouseDrag: !1, responsive: { 0: { items: n }, 600: { items: 3 < i ? 3 : i }, 1e3: { items: i } } });
                    }),
                    ...
                    a(".full-screen-carousel .owl-carousel").owlCarousel({ loop: !0, margin: 10, items: 2, center: !0, autoWidth: !0 }),
                    ...
                    a(".galleryPreview").owlCarousel({ items: 1, center: !0, dotsContainer: "#customDots", autoHeight: !0 }),
                ...
                a(window).bind("load", function () {
                    ...
                    a(".listing-feed-next-btn").click(function (e) {
                        e.preventDefault(),
                            a(this).parents(".container").find(".listing-feed-carousel.owl-carousel").trigger("next.owl.carousel"),
                            a(this).parents(".container").find(".listing-feed-carousel > .owl-item").css("opacity", "0.4"),
                            a(this).parents(".container").find(".listing-feed-carousel > .owl-item.active").css("opacity", "1");
                    }),
                    a(".listing-feed-prev-btn").click(function (e) {
                        e.preventDefault(),
                            a(this).parents(".container").find(".listing-feed-carousel.owl-carousel").trigger("prev.owl.carousel"),
                            a(this).parents(".container").find(".listing-feed-carousel > .owl-item").css("opacity", "0.4"),
                            a(this).parents(".container").find(".listing-feed-carousel > .owl-item.active").css("opacity", "1");
                    }),
                    a(".featured-section-carousel").owlCarousel({ loop: !0, margin: 0, items: 1, center: !0 }),
                    a(".listing-feed-next-btn").click(function (e) {
                    ...
                    a(".lf-background-carousel").owlCarousel({ margin: 20, items: 1, loop: !0 }),
                    ...
                    a(".clients-feed-carousel").owlCarousel({ loop: !0, margin: 20, items: 5, responsive: { 0: { items: 3 }, 600: { items: 3 }, 1e3: { items: 5 } } }),
                ...
                a(".header-gallery-carousel").owlCarousel({
                    ...
                    responsive: { 0: { items: Math.min.apply(Math, [1, l]) }, 480: { items: Math.min.apply(Math, [2, l]) }, 992: { items: Math.min.apply(Math, [3, l]) } },
                }),
                    ...
                    (function () {
                        ...
                        if (e.length) {
                            ...
                            e.click(function (e) {
                                e.preventDefault(), t(), a("html, body").animate({ scrollTop: 0 }, 1e3);
                            });
                            var i = function () {
                            ...
                            a.ajax({
                                ...
                                success: function (e) {
                                    a(".c27-quick-view-modal").removeClass("loading-modal"),
                                        ...
                                        a(".c27-quick-view-modal .c27-map").css("height", a(".c27-quick-view-modal .modal-content").height()),
        ...
        jQuery(document).ready(function (l) {
            ...
            l(".main-loader").addClass("loader-hidden"),
                ...
                l("header.header").parents("section.elementor-element").addClass("c27-header-element"),
                        ...
                        l(window).on(
                            ...
                            MyListing.Helpers.debounce(function () {
                                (i = l(window).scrollTop()),
                                    t !== i &&
                                        (n < i || (n < i && null === t) ? e.addClass("header-scroll") : e.removeClass("header-scroll"),
                                        n + 250 < i ? e.addClass("header-scroll-hide") : e.removeClass("header-scroll-hide"),
                                        (n < i && i < t) || null === t ? e.addClass("header-scroll-active") : e.removeClass("header-scroll-active"),
                                        (t = i));
                            }, 20)
                        );
                    }
        ...
        jQuery(document).ready(function (s) {
            ...
            (s("#commentform")[0].encoding = "multipart/form-data"),
                s("body").on("click", ".review-gallery-image-remove", function (e) {
        ...
        (MyListing.Dialog = function (e) {
            (this.visible = !1), (this.args = jQuery.extend({ message: "", status: "info", dismissable: !0, spinner: !1, timeout: 3e3 }, e)), this.show(), this.setTimeout();
        }),
        ...
        Vue.component("wp-search-filter", {
            props: { listingType: String, filterKey: String, location: String, label: String },
            mounted: function () {
                var e = this;
            ...
            methods: {
                updateInput: function () {
                    (this.filters[this.filterKey] = this.$refs.input.value), this.$emit("input", this.$refs.input.value, { filterType: this.$options.name, filterKey: this.filterKey, location: this.location });
                },
            },
            computed: {
                filters: function () {
        ...
        Vue.component("location-filter", {
            ...
            methods: {
                ...
                updateInput: function (e, t) {
                    ...
                    (this.filters[this.filterKey] = e.address),
                        ...
                        this.$emit("input", this.filters[this.filterKey], { filterType: this.$options.name, filterKey: this.filterKey, location: this.location, shouldDebounce: i });
                },
                ...
                requestALocation: function () {
                    ...
                    if (!e.address || e.latitude || e.longitude) {
                        var i = new MyListing.Dialog({ message: CASE27.l10n.nearby_listings_retrieving_location, timeout: !1, dismissable: !1, spinner: !0 });
                        MyListing.Geocoder.getUserLocation({
                            receivedAddress: function (e) {
                                t.updateInput(e), i.refresh({ message: CASE27.l10n.nearby_listings_searching, timeout: 2e3, spinner: !0, dismissable: !1 });
                            },
                            geolocationFailed: function () {
                                i.refresh({ message: CASE27.l10n.nearby_listings_location_required, timeout: 4e3, dismissable: !0, spinner: !1 }),
                        ...
                        void 0 !== n.defaultLocation
                            ...
                            : MyListing.Geocoder.geocode(e.address, function (e) {
                                  (n.defaultLocation = { address: e ? e.address : "", latitude: !!e && e.latitude, longitude: !!e && e.longitude }), t.updateInput(n.defaultLocation);
                              });
                    }
                },
            },
            computed: {
                currentLocation: function () {
                    return { address: this.filters[this.filterKey] ? this.filters[this.filterKey] : "", latitude: this.filters[this.latitudeKey], longitude: this.filters[this.longitudeKey] };
                },
                filters: function () {
                    return this.$root.types[this.listingType].filters;
                },
        ...
        Vue.component("proximity-filter", {
            props: { listingType: String, filterKey: String, location: String, label: String, units: String, max: Number, step: Number, default: Number },
            data: function () {
                return { locked: !1 };
            },
            mounted: function () {
                var e = this;
                this.$nextTick(function () {
                    jQuery(e.$refs.slider).slider({ range: "min", min: 0, max: e.max, step: e.step, slide: e.updateInput, value: e.filters[e.filterKey] ? parseFloat(e.filters[e.filterKey]) : e.default }),
                        e.$root.$on("reset-filters:" + e.listingType, function () {
            ...
            methods: {
                updateInput: function (e, t) {
                    this.locked || ((this.filters[this.filterKey] = t.value), this.$emit("input", t.value, { filterType: this.$options.name, filterKey: this.filterKey, location: this.location }));
                },
                updateUI: function () {
                    this.locked = !0;
        ...
        Vue.component("date-filter", {
            props: { listingType: String, filterKey: String, location: String, label: String, type: String, l10n: Object },
            data: function () {
                return { startDate: "", endDate: "", dateFormat: "YYYY-MM-DD", locked: !1 };
            },
            created: function () {
            ...
            methods: {
                updateInput: function () {
                    ...
                    (this.filters[this.filterKey] = e), this.locked || this.$emit("input", e, { filterType: this.$options.name, filterKey: this.filterKey, location: this.location, shouldDebounce: !1 });
                },
            },
            computed: {
                filters: function () {
        ...
        Vue.component("date-year-filter", {
            props: { listingType: String, filterKey: String, location: String, choices: Array, label: String, type: String, l10n: Object },
            data: function () {
                    ...
                    new MyListing.CustomSelect(e.$refs.startpicker),
                        ...
                        e.$root.$on("reset-filters:" + e.listingType, function () {
                            (e.locked = !0),
                                ...
                                jQuery(e.$refs.startpicker).val("").trigger("change").trigger("select2:close"),
                                jQuery(e.$refs.endpicker).val("").trigger("change").trigger("select2:close"),
                                (e.locked = !1);
                        });
                });
            },
        ...
        Vue.component("recurring-date-filter", {
            props: { listingType: String, filterKey: String, location: String, label: String, presets: Array, enableDatepicker: Boolean, enableTimepicker: Boolean, l10n: Object },
            data: function () {
                return { selected: "@custom", startDate: "", endDate: "", dateFormat: this.enableTimepicker ? "YYYY-MM-DD HH:mm" : "YYYY-MM-DD", locked: !1, startPicker: null, endPicker: null };
            },
            created: function () {
            ...
            mounted: function () {
                ...
                this.$nextTick(function () {
                    ...
                    (t.startPicker = new MyListing.Datepicker(t.$refs.start, { timepicker: e })),
                        (t.endPicker = new MyListing.Datepicker(t.$refs.end, { timepicker: e })),
        ...
        Vue.component("range-filter", {
            props: { listingType: String, filterKey: String, location: String, label: String, value: String, type: String, prefix: String, suffix: String, min: Number, max: Number, step: Number, formatValue: Boolean },
            data: function () {
                return { defaultValue: "range" === this.type ? "".concat(this.min, "..").concat(this.max) : this.max, locked: !1, debounceUIUpdate: MyListing.Helpers.debounce(this.updateUI, 200) };
            },
            mounted: function () {
                var i = this;
                this.$nextTick(function () {
                    var e = { range: "single" !== i.type || "min", min: i.min, max: i.max, step: i.step, slide: i.updateInput };
            ...
            methods: {
                updateInput: function (e, t) {
                    if (!this.locked) {
                        ...
                        this.$set(this.filters, this.filterKey, n), this.$emit("input", n, { filterType: this.$options.name, filterKey: this.filterKey, location: this.location });
                    }
                },
                updateUI: function () {
                    this.locked = !0;
            ...
            computed: {
                displayValue: function () {
                    ...
                    return jQuery("body").hasClass("rtl")
                        ? "".concat(this.prefix).concat(n).concat(this.suffix, " — ").concat(this.prefix).concat(i).concat(this.suffix)
                        : "".concat(this.prefix).concat(i).concat(this.suffix, " — ").concat(this.prefix).concat(n).concat(this.suffix);
                },
        ...
        Vue.component("dropdown-filter", {
            props: { listingType: String, filterKey: String, location: String, label: String, multiple: Boolean, choices: Array },
            data: function () {
            ...
            methods: {
                ...
                updateInput: function () {
                    ...
                    (this.filters[this.filterKey] = e), this.$emit("input", e, { filterType: this.$options.name, filterKey: this.filterKey, location: this.location });
                },
        ...
        Vue.component("dropdown-terms-filter", {
            props: { listingType: String, filterKey: String, location: String, ajaxParams: String, label: String, preSelected: Array },
            data: function () {
                return { selected: [] };
            },
            created: function () {
        ...
        Vue.component("dropdown-hierarchy-filter", {
            props: { listingType: String, filterKey: String, location: String, label: String, ajaxParams: String, preSelected: String },
            data: function () {
                return { selected: "" };
            },
            created: function () {
            ...
            methods: {
                ...
                updateInput: function () {
                    (this.filters[this.filterKey] = this.selected), this.$emit("input", this.selected, { filterType: this.$options.name, filterKey: this.filterKey, location: this.location });
                },
            },
            computed: {
                filters: function () {
        ...
        Vue.component("related-listing-filter", {
            props: { listingType: String, filterKey: String, location: String, ajaxParams: String, label: String, preSelected: Array, multiple: Boolean },
            data: function () {
                return { selected: this.multiple ? [] : "" };
            },
            created: function () {
        ...
        Vue.component("order-filter", {
            props: { listingType: String, filterKey: String, choices: Array, location: String, label: String },
            data: function () {
                return { locked: !1 };
            },
            mounted: function () {
                ...
                updateInput: function () {
                    this.locked ||
                        ...
                        this.hasNote(this.filters[this.filterKey], "has-proximity-clause")
                            ...
                            : this.$emit("input", this.$refs.select.value, { filterType: this.$options.name, filterKey: this.filterKey, location: this.location, shouldDebounce: !1 }));
                },
                updateUI: function () {
    ...
    function f() {
        jQuery(".mylisting-basic-form").each(function (e, t) {
            if (!t.dataset.inited) {
                ...
                new Vue({
                    el: t,
                    data: { activeType: !1, types: i, targetURL: n.target_url, tabMode: n.tabs_mode, boxShadow: n.box_shadow, formId: n.form_id },
                    created: function () {
